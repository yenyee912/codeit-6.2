  ...
  render() {
    ...
    return (
      <div>
        ...
        {fortune ? 'Alice REJECTED the fortune. Read again.' : ''}
        <br />
        {!playable ? 'Please wait...' : ''}
        <br />
        <button
          disabled={!playable}
          // onClick={() => parent.pickFortune('Today is a good day.')}
          onClick={() => parent.pickFortune(0)}

        >Today is a good day.</button>
        <button
          disabled={!playable}
          onClick={() => parent.pickFortune(1)}
        >Today is a bad day.</button>
        <button
          disabled={!playable}
          onClick={() => parent.pickFortune(2)}
        >Today is a soso day.</button>
      </div>
    );
  }
}
    ...
    return (
      <div>
        ...
        <button
          ...
          onClick={() => parent.makeChoice(0)}
        >Reject</button>
        <button
          disabled={!playable}
          onClick={() => parent.makeChoice(1)}
        >Accept</button>
      </div>
    );
  }
